<aside id="left-panel" class="left-panel">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Add new Patient</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Update details</a></li>   
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">Female Beds</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">Male Beds</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-email"></i>ICU Beds requests </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
    ...
    </aside><?php /**PATH C:\xampp\htdocs\Git-Hospital\Hospital-System\resources\views/layouts/sidebarhos.blade.php ENDPATH**/ ?>