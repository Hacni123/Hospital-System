                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Confirm Ambulance Request</li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Confirm Ambulance</strong> Requests
                                                    </div>
                                                    @if ($errors->any())
                                                   ...
                                                   @endif
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="{{ route('approveambrequest.update') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                        @csrf
                                                        <input type="hidden" name="icuid" value="{{$Info->id}}">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" id="ambulance_id" name="ambulance_id" class=" form-control-label" >Ambulance No</label></div>
                                                                <div class="card-body">

                                                                <select name="ambulance_id" data-placeholder="Choose a action" class="standardSelect" tabindex="1">
