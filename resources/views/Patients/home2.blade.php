               ...
               <div class="right-header">
                  <div class="header-info">
                     <div class="info-inner">
                        ...
                        <span class="iconcont"><a href="tel:800 123 456">+942221324</a></span>	
                     </div>
                     <div class="info-inner">
                     ...
                     <div class="info-inner">
                        ...
                        <span class="iconcont"><a data-scroll href="#">7x24 hours available</a></span>	
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <p class="lead" align="justify">Hospital Services may be defined as facilities and utilities offered by hospitals in the form of medical and surgical assistance, laboratory and pharmaceutical provisions, staff and specialists, advanced equipment etc.</p>
                     <p  align="justify"> In short, hospital services include anything and everything that hospitals offer to their recipients. Most of these depend on the hospital’s motto, customer requirements and expectations.Depending on the type of hospitals, the services they offer vary. However, every hospital needs to provide some core and mandatory services.  </p>
            ...
            <div class="row">
               <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                  <div class="inner-services">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="assets/images/icons8-hospital-room-100.png" alt="#" /></span>
                           <h4>ICU BEDS AVAILABILITY</h4>
                           
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="assets/images/icons8-ambulance-64.png" alt="#" /></span>
                                 ...
                                 <div class="row">
                                    <div class="form-group">
                                       <select class="form-control">
                                          ...
                                          <option>Vavuniyah</option>
                                          <option>Mullaithuvu</option>
