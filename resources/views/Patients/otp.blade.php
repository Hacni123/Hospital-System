                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <div class="form-group">
                                            <input type="otp" name="otp" class="form-control form-control-user" id="exampleInputotp" 
                                        ...
                                        <input type="submit" name="OTP" href="{{URL::to('/login')}}" class="btn btn-primary btn-user btn-block" placeholder="OTP"></input>
